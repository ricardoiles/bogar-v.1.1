...
-- Tiempo de generación: 16-01-2023 a las 16:04:51
...
CREATE TABLE `blog` (
  ...
  `eliminacion_entrada` text DEFAULT NULL
...
(1, 'cesar', '                                                                            Me dedico a ser musico de sesion acompaÃ±ando artistas en la bateria para shows en vivo y grabaciones.\r\n\r\nSoy educador musical con mas de 8 aÃ±os de experiencia, creo programas personalizados corta y larga duracion para mentorÃ­as 1-1 o grupales. He impartido clases en escuelas como ICM, Reaktor y actualmente imparto en Bogar Online (proyecto propio).\r\n\r\nFusiono la baterÃ­a con el malabar y realizo Trading.\r\n                                                                         ', 'CNOnline Instrumento1(about2).png', '2023-01-02 20:21:48'),
